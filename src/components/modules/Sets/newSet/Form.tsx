    ...
    return (
        <div className=" flex flex-col mt-10 mb-20 mx-auto p-5">
            ...
            <div className="flex flex-col md:flex-row justify-around">
                <FormInput type="text" name="title" placeholder="Title" setter={(event: React.ChangeEvent<HTMLInputElement>) => formHandler(event)} />
                <FormInput type="text" name="hero" placeholder="Hero" setter={(event: React.ChangeEvent<HTMLInputElement>) => formHandler(event)} />
            </div>
            <div className="flex justify-around flex-col md:flex-row">
                <FormInput type="number" name="price" placeholder="Price" setter={(event: React.ChangeEvent<HTMLInputElement>) => formHandler(event)} />
                <FormInput type="text" name="year" placeholder="Year" setter={(event: React.ChangeEvent<HTMLInputElement>) => formHandler(event)} />
                <FormInput type="text" name="category" placeholder="Category" setter={(event: React.ChangeEvent<HTMLInputElement>) => formHandler(event)} />
            </div>
