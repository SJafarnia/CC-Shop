function SetListLoading() {
    return (
        <div className="grid xs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {Array(6).fill("").map(() => {
                return (
                    <div className="mx-2 relative flex flex-col justify-between rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]sm:shrink-0 sm:grow sm:basis-0">
                        <div
                            className="rounded-md animate-pulse bg-gray-200  h-[352.55px] w-[317px]"
                        />
